import { MixedRoute, partitionMixedRouteByProtocol, Protocol, Trade } from '@bitciswap/router-sdk'
import { Currency, CurrencyAmount, Percent, TradeType } from '@bitciswap/sdk-core'
import { Pair } from '@bitciswap/v2-sdk'
import { Pool } from '@bitciswap/v3-sdk'
